...
Thanks for the questions. Let me clarify what we're actually doing here, since I think there's some confusion about what "breaking the monolith" means in this first phase.
...
Some teams will get to autonomy sooner and will start operating faster immediately. But shifting to 50/50 in Q3 means allocating capacity to commercial work when 70-80% of teams still have deployment friction. You'll burn the allocation without proportional output increase.

My view: Stay at 25/75 through Q4, shift to 50/50 in Q1 2027 once we have 4-5 teams proven autonomous, demonstrating velocity improvements, and P0 database issues addressed. 
