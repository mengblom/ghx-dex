...
2. Productivity Assessment
	1. There are positives signs in data
		...
		8. Org changes (will talk more about that below)
	2. Challenges
		...
		6. Product - Engineering; best practice calls for 1-1 Product Owner to EM/engineering team, we don't have that product engagement
		7. Always a request for some data that we don't have automated
...
4. We are also tracking against the other resiliency priorities (ties this to the priorities in [2026 Tech Org Priorities.pptx](https://ghx365-my.sharepoint.com/:p:/r/personal/csingh_ghx_com/Documents/2026/2026%20Tech%20Org%20Priorities.pptx?d=w3d38032c08714d5eb49a0b00d8ecc1ae&csf=1&web=1&e=jwqa7k))
	1. Atlast migration - On track for completion August 29
	2. DR test - Lower environment test: RTO 4:45, RPO: 0:15, Internal target October, External comms December
	3. Vulnerabilities / EOL technologies - Addressed by Red Mythos project, tracking for July 2 completion
	4. ICS - Building a new team of FTEs to take this over inhouse from contractors
5. Now on to the monolith (which ties to the 5th Exchange related item in [2026 Tech Org Priorities.pptx](https://ghx365-my.sharepoint.com/:p:/r/personal/csingh_ghx_com/Documents/2026/2026%20Tech%20Org%20Priorities.pptx?d=w3d38032c08714d5eb49a0b00d8ecc1ae&csf=1&web=1&e=6lwGFR&nav=eyJzSWQiOjIxNDc0ODM2MjgsImNJZCI6MjEyNjg5NTUyOH0) "- Increase Modularity i.e., continuebreaking the monolith​")
	1. The problem with the monolith
		1. "The monolith" is both a technical and organizational problem
		2. The vicious cycle (get slides from [Exchange - Building Autonomous Teams.pptx](https://ghx365-my.sharepoint.com/:p:/r/personal/mengblom_ghx_com/Documents/Documents/Projects/Exchange%20Org%20Changes%2025-26/Exchange%20-%20Building%20Autonomous%20Teams.pptx?d=w1fd29fbd375547599f028fe5c73faeca&csf=1&web=1&e=1PIff2))
	...
	4. What is happening right now
		...
		2. Template for breaking pieces off the monolith
			1. Things like:
				1. Move your components to Github repo
				2. Stand up your deployment pipelines
				3. ...
		3. AI-Native SDLC
	...
	5. "End" of resiliency work? / When are we out of the woods?
		1. Must Haves (we will not be stable, or cannot execute properly without these):
			1. Autonomous teams (we just talked about this extensively)
				1. Dedicated EM, PO
				2. Agile process - dedicated Jira project, backlog
				3. that own and deploy their components independently
				4. own their own application-near infra
				5. own their own deployment pipelines
				6. are sprinting independently
				7. "Team API" (slack channels according to convention etc.)
			2. Address the most egregious issues in our data layer (Data stored in the correct "products" - move to cloud native / infinitely scalable (DynamoDB, S3 etc.) where appropriate, read and write patterns considered when choosing where and how to store data, redirect dependencies to Common Data Platform (CDP) where appropriate, be thoughtful and intentional about data retention,...) 
				1. Scalability
				2. Cost
				3. HA / DR is literally a setting
		2. Still required, but timing is negotiable/trade-offs possible (will continue to hold us back, or said differently, I'd be shocked if Veritas / Kickdrum doesn't comment on this)
			...
			4. Observability
6. Capacity pie chart evolution
	1. Starting point: 65% Technical, 35% Commercial Roadmap
	2. ...
7. The future
