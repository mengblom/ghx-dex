...
kb_insights: true
---
- India time tracking - email chain with Ramesh and Swastik pushing back on the practice
- Hiring
	- [Exchange Hiring Portal - Global Exchange Development - Confluence](https://prd.hub.ghx.com/wiki/spaces/EX/pages/33922548/Exchange+Hiring+Portal)
	- [[Ramesh]]: 
		- We have not even opened the lower level IC roles
	- Marten: Let's open lower IC roles as well.
- Document Classification / Extraction (i.e. the UI Path replacement)
	- Radha is proposing to use a hybrid approach of using Claude for Classification & Bautomate for Extraction: If we were to build our own tool, we need ~6 months of training and transition. Proposes:
		- 1. to build a v1 LLC based solution for classification only
		- 2. Use BAutomate for human in the loop enabled extraction
	- This seems like a waste of time/money to onboard Bautomate just to get rid of it 6 months later
	- Radha and Ramesh are going to book a meeting