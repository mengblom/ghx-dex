...
- Managed Services Team
	- We (Ramesh) just inherited this
	- Have built a portal "Managed Services Portal"
		- Originally by Happiest Minds 
		- Is used internally by ~90 CX people
		- Chrystie claims this is one of the fastest growing SKU at GHX
	- Only 2 people are managing this
	- 6 more people have joined recently
	- In addition to the Managed Services portal, the CX people are using Salesforce
		- Inefficient, we are being asked to replicate the Salesforce functionality in the Managed Services Portal