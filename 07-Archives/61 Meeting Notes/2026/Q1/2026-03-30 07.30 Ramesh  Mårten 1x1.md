...
kb_insights: false
---
- Question for Ramesh: How have the updates to the Hybrid Work Model in India been received?
	- Some people have concerned with the split schedule (e.g. Mon, Tue, Thu)... some people have their families in other cities.
- Friction between EU Stakeholders & Dejas' mapping team
	- Joanna is perceived as aggressive, 
	- Glenn Carter and Chaturi used to do the business analysis
	- When he is out, there is an expectation that the engineering team steps in... 
- Matt Turner
	- Mixed feedback from Ramesh
	- Initially very set in his ways, resistant to ideas
	- Have kind of come around...
	- ... but still a little brash 
	- We need to make sure Matt doesn't strongarm the team into a direction that is only his idea
- IPA Migration
	- Currently:
		- UIPath 20% of traffic
		- First Source: 80% of traffic
	- The original plan was:
		- Build a 1.0 version of new LLM based solution
		- 